...
if(isset($_GET['dId'])){
    $id = $_GET['dId'];
    $query = "DELETE FROM sub_sub_category WHERE id = '$id'";
                  ...
                  <div class="row">
                     <div class="col-sm-12">
                           <div class="row pull-right m-b-20" id="show">
                            <div class="col-md-2">
                              <div class="btn btn-primary btn-sm add">+&nbsp;&nbsp;&nbsp;Add New Sub Sub Category</div>
                            </div>
                          </div>
                        <div class="card-box" id="hide">
                           <div class="row">
                              <form class="form-horizontal" role="form" action="action/sub_sub_category.php" method="post">
                                 <div class="col-md-12">
                                    <div class="row">
                                        <div class="col-md-6">
                           ...
                           <table id="datatable-buttons" class="table table-striped table-bordered">
                              <thead>
                                 <tr>
                                    ...
                                    <th style="width:30%;">Sub Sub Category</th>
                              ...
                              <tbody>
                                 <?php
            $query = "SELECT * FROM sub_sub_category order by id DESC";
            ...
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                ?>
                                   <tr>
                                       ...
                                       <td> 
                                        <?php
                                            if(isset($row['sub_sub_category']) && !empty($row['sub_sub_category']))
                                            {
                                                echo $row['sub_sub_category']; 
                                            }
                                            ?>
                                        </td>
                                        <td> 
                                       ...
                                       <td>
                                          <a href="sub_sub_category.php?hId=<?php if (isset($row['id']) &&
                                                        !empty($row['id'])) {echo $row['id'];} ?>" title="Edit">
                                                        <i class="fa fa-edit" style="font-size: 20px;"></i>
                                                        </a>
                                                 <a href="sub_sub_category.php?dId=<?php if(isset($row['id']) && !empty($row['id'])){ echo $row['id']; }?>" onClick="return confirm('Are you sure you want to delete this record');" title="Delete">
